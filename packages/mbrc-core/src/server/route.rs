//! First-frame protocol routing.
//!
//! V6 runs parallel to the frozen V4/V5 protocol on the same port (#118 §6), and
//! both are newline-JSON, so a connection is routed by the *shape* of its
//! opening frame rather than the first byte.
//!
