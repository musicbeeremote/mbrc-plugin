//! V6 player-control handlers.
//!
//! The provider calls are identical to the legacy
...
use super::{OpResult, V6Error, internal, req_bool, req_i64, req_str};
...
///
/// Enabling it without a last.fm account cannot succeed - MusicBee pops a
/// blocking login modal - so that is a precondition error rather than a generic
/// internal failure.
