//! V6 playlist domain: list playlists and play one.
//!
//! `playlist_tracks` (#82) and the playlist mutations (#115) are feature
//! requests rather than V4 features, and are not served here.

use serde_json::{Value, json};

use super::{OpResult, internal, page_args, page_json, req_str};
