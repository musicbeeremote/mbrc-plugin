    ...
    public partial class Plugin
    {
        ...
        public struct MusicBeeApiInterface
        {
            public void Initialise(IntPtr apiInterfacePtr)
            {
                ...
                else if (MusicBeeVersion == Plugin.MusicBeeVersion.v2_3)
                    Plugin.CopyMemory(ref this, apiInterfacePtr, 596);
                else if (MusicBeeVersion == Plugin.MusicBeeVersion.v2_4)
                    Plugin.CopyMemory(ref this, apiInterfacePtr, 604);
                else
